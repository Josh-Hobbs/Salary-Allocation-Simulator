...
#Asks the user for input regarding their salary and monthly expenses
...
#Calculates monthly expenses, savings, and yearly savings
...
#Defining the figure to include all three graphs in the output and adding a title to the figure

fig, (ax1,ax2,ax3) = plt.subplots(1,3)
fig.set_facecolor((0.87,0.87,0.87))
fig.suptitle("The Allocation of an $"+str(Salary)+" Salary",fontsize=16)

#Creates a bar graph to visualize how much the user earns, spends and saves in a month
...
#Creates a pie chart to illustrate how much each expense catagory affects the user's total expenses
...
for i in ExpensesList:
    PieSlice.append((i/MonthlyExpenses)*10) #---> Finds the proportion of each expense to the total amount spent that month
...
#Creates a bar graph to visualize the catagorization of the user's monthly expenses
